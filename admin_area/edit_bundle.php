...
<label> Bundle Seo Description </label>
...
<label> Bundle Weight <small> (kg)</small> </label>
...
<label> Select A Bundle Type </label>

<select class="form-control" name="product_type"><!-- select manufacturer Starts -->

<?php if($p_type == "physical_product"){ ?>

<option value="physical_product" selected> (Physical Product) Simple Bundle </option>

<option value="digital_product"> (Digital Product) Downloadable Bundle </option>

<option value="variable_product"> (Variable Product) Advanced Bundle </option>

<?php }elseif($p_type == "digital_product"){ ?>

<option value="physical_product"> (Physical Product) Simple Bundle </option>

<option value="digital_product" selected> (Digital Product) Downloadable Bundle </option>
...
<option value="variable_product" selected> (Variable Product) Advanced Bundle </option>
...
<label> Bundle Inventory Stock Management </label>
...
<label> Enable stock management at Bundle level? </label>

<div class="radio">

<label>

<input type="radio" name="enable_stock" value="yes" <?php if($enable_stock == "yes"){ echo "checked"; } ?> required> Yes
...
<label> Variable Bundle Options </label>
...
<a data-toggle="tab" href="#product_attributes"> Bundle Attributes </a>

</li>

<li>

<a data-toggle="tab" href="#product_variations"> Bundle Variations </a>
...
These are the Bundle attributes that will be pre-selected on the frontend.
...
echo "<script>alert('Your Bundle Image 1 File Extension Is Not Supported.')</script>";
...
echo "<script>alert('Your Bundle Image 2 File Extension Is Not Supported.')</script>";
...
echo "<script>alert('Your Bundle Image 3 File Extension Is Not Supported.')</script>";
