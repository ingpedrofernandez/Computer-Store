...
<h4> <strong> Edit Shipping Rates For : </strong> <?php echo $zone_name ?> : <?php echo $type_name ?> </h4>

<?php }elseif(isset($_GET["country_id"])){ ?>

<h4> <strong> Edit Shipping Rates For : </strong> <?php echo $country_name ?> : <?php echo $type_name ?> </h4>
