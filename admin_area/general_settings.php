...
<input type="radio" name="enable_vendor" value="yes" <?php if($enable_vendor == "yes"){ echo "checked"; } ?> required> Yes
...
This option means whether vendors are able to register on your website are not.
...
<option value="active" <?php if($new_product_status == "active"){ echo "selected"; } ?>> (Active) Published </option>

<option value="pending" <?php if($new_product_status == "pending"){ echo "selected"; } ?>> (Pending) Pending Approvel </option>

</select><!-- select manufacturer Ends -->

<span id="helpBlock" class="help-block">

Product status when a vendor creates a product.
...
<input type="checkbox" name="order_status_change" value="yes" <?php if($order_status_change == "yes"){ echo "checked"; } ?>> Vendor can update/change order status.
...
<input type="submit" name="submit" class="form-control btn btn-primary" value="Update General Settings">
...
alert(' Your General Settings Has Been Updated Successfully. ');
