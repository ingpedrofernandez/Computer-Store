...
<i class="fa fa-dashboard"> </i> Dashboard / Insert Bundles
...
<input type="submit" name="submit" value="Insert Bundle" form="insert_product_form" class="btn btn-primary form-control">
