...
<h3> 
Change Account Password <span class="text-muted h6"> If You Not Want To Change Password Leave These Fields Empty. </span> 
</h3>
...
echo "<script>alert('Your Password Do Not Match, Please Try Again.');</script> ";
