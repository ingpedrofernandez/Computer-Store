...
<i class="fa fa-dashboard"></i> Dashboard / View Vendors Commissions
...
<h3 style="margin-top:0px;"> Filter Vendors Commissions </h3>
...
<option value="pending" <?php select_commission_status("pending"); ?>> Pending Clearance </option>
...
<i class="fa fa-money fa-fw"> </i> View Vendors Commissions
...
<h3> Sorry, We Have Not Found Any Vendors Commissions. </h3>
...
<a href="index.php?clear_commission=<?php echo $commission_id; ?>" onclick="return confirm('Do You Really Want To Clear/Paid This Commission , After Commission Cleared, Vendor Can Withdraw Commission Amount.');">
