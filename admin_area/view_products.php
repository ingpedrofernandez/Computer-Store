...
<h3 style="margin-top:0px;"> Filter Products </h3>
...
<option value="physical_product" <?php select_product_type("physical_product"); ?>> (Physical Product) Simple Product </option>

<option value="digital_product" <?php select_product_type("digital_product"); ?>> (Digital Product) Downloadable Product </option>

<option value="variable_product" <?php select_product_type("variable_product"); ?>> (Variable Product) Advanced Product </option>
...
<option value="instock" <?php select_stock_status("instock"); ?>>In stock</option>

<option value="outofstock" <?php select_stock_status("outofstock"); ?>>Out of stock</option>

<option value="onbackorder" <?php select_stock_status("onbackorder"); ?>>On backorder</option>
...
<button type="submit" class="btn btn-success form-control"> Filter Products </button>
...
<h3> Sorry, We Have Not Found Any Products. </h3>
