...
if($http_referer == "insert_product" or $http_referer == "edit_product=$product_id" or $http_referer == "insert_bundle" or $http_referer == "edit_bundle=$product_id"){
...
data: { product_id: <?php echo $product_id; ?>, default_variation_id: <?php echo $default_variation_id; ?>, variation_ids: variation_ids, selected_attributes: selected_attributes, variation_meta_array: product_attributes },
