...
<option value="physical_product" <?php select_product_type("physical_product"); ?>> (Physical Bundle) Simple Bundle </option>

<option value="digital_product" <?php select_product_type("digital_product"); ?>> (Digital Bundle) Downloadable Bundle </option>

<option value="variable_product" <?php select_product_type("variable_product"); ?>> (Variable Bundle) Advanced Bundle </option>
