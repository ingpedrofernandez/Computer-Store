...
<i class="fa fa-money fa-fw"> </i> Your Are Viewing Complete Details Of This Order <mark>#<?php echo $invoice_no; ?></mark> was placed on <mark><?php echo $order_date; ?></mark> and is currently <mark><?php 
...
<option value="processing" <?php select_order_status("processing"); ?>> Processing </option>
...
<textarea name="note_content" rows="3" placeholder="Private Notes about your order, e.g. special notes for delivery." class="form-control"></textarea>
...
<input type="submit" name="insert_note" value="Insert Note" class="form-control btn btn-primary">
