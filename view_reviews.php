...
<option value="1" <?php if(isset($_REQUEST["review_rating"]) and $_REQUEST["review_rating"] == 1){ echo "selected"; } ?>> 1 Star </option>

<option value="2" <?php if(isset($_REQUEST["review_rating"]) and $_REQUEST["review_rating"] == 2){ echo "selected"; } ?>> 2 Stars </option>

<option value="3" <?php if(isset($_REQUEST["review_rating"]) and $_REQUEST["review_rating"] == 3){ echo "selected"; } ?>> 3 Stars </option>

<option value="4" <?php if(isset($_REQUEST["review_rating"]) and $_REQUEST["review_rating"] == 4){ echo "selected"; } ?>> 4 Stars </option>

<option value="5" <?php if(isset($_REQUEST["review_rating"]) and $_REQUEST["review_rating"] == 5){ echo "selected"; } ?>> 5 Stars </option>
...
<input type="hidden" name="review_status" value="<?php echo $_REQUEST["review_status"]; ?>">
...
<a href="index.php?view_reviews=1&review_status=pending<?php echo $filter_url; ?>" class="link-separator <?php echo_active_class("pending"); ?>">
...
<a href="index.php?view_reviews=1&review_status=active<?php echo $filter_url; ?>" class="link-separator <?php echo_active_class("active"); ?>">
...
<a href="index.php?view_reviews=1&review_status=spam<?php echo $filter_url; ?>" class="link-separator <?php echo_active_class("spam"); ?>">
...
<a href="index.php?view_reviews=1&review_status=trash<?php echo $filter_url; ?>" class="link-separator <?php echo_active_class("trash"); ?>">
...
<a href='index.php?view_reviews=$i$filter_url' class='page-link'>
...
<a href='index.php?view_reviews=$total_pages$filter_url' class='page-link'>
